  ...
  try {
    ...
    try {
      ...
      const writeResponse = await sheets.spreadsheets.values.append({
        ...
        requestBody: {
          values: [["Manual Test", new Date().toISOString()]],
        },
      })

      return NextResponse.json({
        success: true,
        message: "Successfully connected to and wrote to Google Sheet with provided credentials",
      ...
      return NextResponse.json({
        success: false,
        error: "Failed to connect to Google Sheets with provided credentials",
